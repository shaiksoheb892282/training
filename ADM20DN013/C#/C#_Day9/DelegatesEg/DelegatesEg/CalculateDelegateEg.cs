...
namespace DelegatesEg
{
    ...
    class CalculateEg
        ...
        CalDel calDel;//creating the reference for our delegate type
    ...
    class Demo
    {
        static void Main()
        {
            ...
            do
            {
                ...
                if (choice != 0)
                    new CalculateEg(choice).GetNumbers();//Delegate is initialized in the overloaded constructor of CalculateEg class
            } while (choice != 0);

            //Another Simple way of using Delegate with default constructor of CalculateEg
            CalculateEg c = new CalculateEg();
