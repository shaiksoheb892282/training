...
alter proc procInsertStudent(@stid varchar(10),@stname varchar(30),@stdob date) as
begin
...
alter proc procStudentById(@stid varchar(10)) as
begin
...
alter proc procGetEnrollments(@stid varchar(10),@cid varchar(10))as
begin
select * from Student where ID=@stid;
select * from Course where CID=@cid;
end;