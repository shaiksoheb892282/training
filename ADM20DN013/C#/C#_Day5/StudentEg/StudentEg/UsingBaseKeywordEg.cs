...
namespace BaseStudentEg
{
	...
	public class Program
    {
		...
		{
			new Student().getDetails();//Anonymous Object thta can be used only once to call a method of any class

			HostelStudent hs = new HostelStudent("Kanav", "001", 6);
			hs.getDetails();
			/* calling the constructor of the derived class */
			FinalYearStudent fhs = new FinalYearStudent("Kanav", "001", 6, "I7", 60);
			fhs.getDetails();
